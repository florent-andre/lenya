...
public class MoveSubsiteTest extends AbstractUsecaseTest {
	...
	//use static test publication here, as this module is required by export
    protected static String pubName = "statictest";
    
    protected static final String PATH = "/foo/bar/baz";
    protected static final String DELETE_URL = "/"+pubName+"/authoring" + PATH + ".html";
    protected static final String TARGET_URL = "/"+pubName+"/authoring/foo_de.html";
    ...
    protected void checkPostconditions() throws Exception {
        ...
        Area authoring = getPublication(pubName).getArea("authoring");
        SiteStructure authoringSite = authoring.getSite();
        assertFalse(authoringSite.contains(PATH));

        Area trash = getPublication(pubName).getArea("trash");

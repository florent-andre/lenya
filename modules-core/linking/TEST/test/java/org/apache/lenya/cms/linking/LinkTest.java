...
public class LinkTest extends AbstractAccessControlTest {
    ...
    public void testLinks() throws Exception {
        ...
        Publication pub = getPublication("statictest");
    ...
    public void testInterPublicationLinks() throws Exception {
        ...
        final Publication defaultPub = getPublication("staticDefault");
        ...
        final Publication pub = getPublication("statictest");
        ...
        final String absoluteLink = relativeLink + ",pub=statictest";
